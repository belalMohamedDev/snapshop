...
class _AppServiceClient implements AppServiceClient {
  _AppServiceClient(this._dio, {this.baseUrl, this.errorLogger}) {
    baseUrl ??= 'https://nti-ecommerce-api-production-f760.up.railway.app/api/';
  }
  ...
  Future<OrdersModel> getOrders() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<OrdersModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'orders',
  ...
  @override
  Future<ProductModel> getTopRatedProducts() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  Future<ApiSuccessGeneralModel> placeOrder(
    ...
    _data.addAll(placeOrderRequest.toJson());
    final _options = _setStreamType<ApiSuccessGeneralModel>(
  ...
  @override
  Future<ApiSuccessGeneralModel> cancelOrder(int id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<ProductModel> search(String q) async {
    final _extra = <String, dynamic>{};
